...
<ul>
   ...
   <div class="sidepanel">
       <div class="wrapper">
   <button class="tablink" onclick="openPage('alle', this, 'orange')"  id="defaultOpen">Alle</button>
   <button class="tablink" onclick="openPage('mine', this, 'red')">Mine tickets</button>
   <button class="tablink" onclick="openPage('ingensine', this, 'green')">Alle nonassigned</button>
      </div>
   </div>
   
   <div id="alle" class="tabcontent">
   ...
   <div id="mine" class="tabcontent">
       ...
       INNER JOIN Innhold_i_ticket ON Ticket.ticketid = Innhold_i_ticket.ticketid
       INNER JOIN Kunde ON Ticket.kundeid = Kunde.kundeid 
       WHERE Ticket.ansattid = " . $_SESSION['id'] . "";
   ...
   <div id="ingensine" class="tabcontent">
       <div class="ticket-wrapp">
           <div class='ticket-width'>
       <?php
       $sql = "SELECT Ticket.ticketid, Ticket.kundeid, Ticket.dato, Ticket.beskrivelse, Ticket.status, Ticket.ansattid, Innhold_i_ticket.Innhold, kunde.epost, kunde.fornavn, kunde.etternavn
       ...
       INNER JOIN Innhold_i_ticket ON Ticket.ticketid = Innhold_i_ticket.ticketid
       INNER JOIN Kunde ON Ticket.kundeid = Kunde.kundeid 
       WHERE Ticket.ansattid = 'nonassigned'";
